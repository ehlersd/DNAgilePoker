                  ...
                  animated:(BOOL)animated
{
    ...
    if ([newViewState isEqualToString:LOGWelcomeViewViewStateSignInProcessing] == YES)
    {
        [self spinWithOptions:UIViewAnimationOptionCurveEaseIn];
    }

    if ([newViewState isEqualToString:LOGWelcomeViewViewStateResetPasswordProcessing] == YES)
    {
        [self spinWithOptions:UIViewAnimationOptionCurveEaseIn];
    }
}
